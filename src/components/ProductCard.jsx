...
export default function ProductCard({ product, addToCart }) {
  return (
    <div className='w-48 p-5 flex flex-col items-center gap-2 border rounded-lg'>
      ...
      <div className='flex flex-col gap-2 font-montserrat font-semibold text-sm'>
        <button className='border py-2 px-4 rounded-full'>Learn More</button>
        <button 
          onClick={() => addToCart(product)} // Add to Cart is triggered here
          className='bg-tan py-2 px-4 rounded-full text-white'>
          Add to Cart
        </button>
      </div>
    </div>
