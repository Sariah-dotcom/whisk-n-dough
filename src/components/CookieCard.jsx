...
export default function CookieCard({ bgprimary, cookieImg, cookieName, cookieDescription }) {
  return (
    <div className={`flex flex-col gap-5 items-center rounded-t-full rounded-b-md text-white text-center px-5 border border-dark-brown ${bgprimary}`}>
      ...
      <div className='flex flex-col items-center gap-6 pt-5 pb-12'>
        ...
        <div className='flex gap-5 font-montserrat font-semibold'>
